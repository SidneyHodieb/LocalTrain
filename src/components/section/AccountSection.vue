                            ...
                            <div class="tab-content mt-4" id="myTabContent">
                                <div class="tab-pane fade show active" id="account-information" role="tabpanel" aria-labelledby="account-information-tab">
                                    <div class="profile-setting-panel">
                                        <h5 class="mb-4">Modifier le profil</h5>
                                        ...
                                        <div class="row mt-4">
                                            ...
                                            <div class="col-lg-6 mb-3">
                                                <label for="displayUserName" class="form-label">Last name</label>
                                        ...
                                        <div class="row">
                                             <div class="col-lg-6 mb-3">
                                                <label for="twitterLink" class="form-label"> Téléphone</label>
                                                <input type="text" id="twitterLink" class="form-control form-control-s1" value="https://twitter.com/">
                                            </div>
                                            <div class="col-lg-6 mb-3">
                                                <label for="facebookLink" class="form-label">Date de naissance</label>
                                        ...
                                        <button class="btn btn-primary mt-3" type="button">Mettre à Jour </button>
